...
var createGrib2Layer = (strength) => {
  ...
  if (strength === 'ERTOA') {
    ...
    var layers = 'nhc:AL052019_TOA_TOD_34kt_adv007_227'
  } else if (strength === 'MLTOA') {
    console.log('MLTOA works');
    var layers = 'nhc:AL052019_TOA_TOD_34kt_adv007_228'
...
map.on('singleclick', function (evt) {
  ...
  <wps:DataInputs>
      ...
      <wps:Input>
        ...
        <wps:Data>
          <wps:LiteralData>nhc:AL632019_TOA_TOD_34kt_adv007_227,nhc:AL052019_TOA_TOD_34kt_adv007_228,nhc:AL052019_TOA_TOD_34kt_adv007_229,nhc:AL052019_TOA_TOD_34kt_adv007_230</wps:LiteralData>
        </wps:Data>
      </wps:Input>
      <wps:Input>
