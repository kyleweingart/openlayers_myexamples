...
// in progress crop coverage by input geometry
// need to make coordinates a variable that is gotten from WFS feature request

  const wpFeatureRequest = new WFS(
    ).writeGetFeature({
      srsName: 'EPSG:3857',
      featurePrefix: 'nhp',
      featureTypes: ['basins_clipped'],
      outputFormat: 'application/json',
      filter: equalToFilter('abbr', 'sf1'),
      // )
    });
  ...
  fetch('https://dev-hvx.hurrevac.com/geoserver/wfs', {
    ...
    fetchCroppedImage(coords)
    // map.addLayer(wpVector);
  });

function fetchCroppedImage(coords) {
  const cropCoverage = `<?xml version="1.0" encoding="UTF-8"?><wps:Execute version="1.0.0" service="WPS" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="http://www.opengis.net/wps/1.0.0" xmlns:wfs="http://www.opengis.net/wfs" xmlns:wps="http://www.opengis.net/wps/1.0.0" xmlns:ows="http://www.opengis.net/ows/1.1" xmlns:gml="http://www.opengis.net/gml" xmlns:ogc="http://www.opengis.net/ogc" xmlns:wcs="http://www.opengis.net/wcs/1.1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xsi:schemaLocation="http://www.opengis.net/wps/1.0.0 http://schemas.opengis.net/wps/1.0.0/wpsAll.xsd">
  ...
  <wps:DataInputs>
      ...
      <wps:Reference mimeType="image/tiff" xlink:href="http://geoserver/wcs" method="POST">
        <wps:Body>
          <wcs:GetCoverage service="WCS" version="1.1.1">
            <ows:Identifier>nhp:US_SLOSH_MOM_Inundation</ows:Identifier>
            <wcs:DomainSubset>
              <ows:BoundingBox crs="http://www.opengis.net/gml/srs/epsg.xml#4269">
                <ows:LowerCorner>-98.05986540280205 24.491674407495882</ows:LowerCorner>
                <ows:UpperCorner>-66.88545057790614 46.39583486890382</ows:UpperCorner>
              </ows:BoundingBox>
            </wcs:DomainSubset>
    ...
    <wps:Input>
      ...
      <wps:Data>
        <wps:ComplexData mimeType="application/json"><![CDATA[{"type":"MultiPolygon","coordinates":${coords}></wps:ComplexData>
      </wps:Data>
    </wps:Input>
  </wps:DataInputs>
  <wps:ResponseForm>
